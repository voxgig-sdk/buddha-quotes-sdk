...
function runner.env_override(m)
  local live = runner.getenv("BUDDHA_QUOTES_TEST_LIVE")
  local override = runner.getenv("BUDDHA_QUOTES_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BUDDHA_QUOTES_TEST_EXPLAIN")
