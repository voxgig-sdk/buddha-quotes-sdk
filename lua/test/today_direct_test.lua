...
describe("TodayDirect", function()
  it("should direct-load-today", function()
    local setup = today_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-today", setup.live and "live" or "unit")
