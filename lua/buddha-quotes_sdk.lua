...
local BuddhaQuotesSDK = {}
BuddhaQuotesSDK.__index = BuddhaQuotesSDK
...
BuddhaQuotesSDK._make_feature = _make_feature


function BuddhaQuotesSDK.new(options)
  local self = setmetatable({}, BuddhaQuotesSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BuddhaQuotesSDK:options_map()
...
function BuddhaQuotesSDK:get_utility()
  return Utility.copy(self._utility)
end


function BuddhaQuotesSDK:get_root_ctx()
  return self._rootctx
end


function BuddhaQuotesSDK:prepare(fetchargs)
...
function BuddhaQuotesSDK:direct(fetchargs)
...
-- by passing it.
function BuddhaQuotesSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function BuddhaQuotesSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "BuddhaQuotesSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function BuddhaQuotesSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BuddhaQuotesSDK.new(sdkopts)
  sdk.mode = "test"
