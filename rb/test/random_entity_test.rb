...
class RandomEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BUDDHA_QUOTES_TEST_RANDOM_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def random_basic_setup(extra)
  ...
  entid_env_raw = ENV["BUDDHA_QUOTES_TEST_RANDOM_ENTID"]
