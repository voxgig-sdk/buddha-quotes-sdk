...
#      offline in seeded test mode (BuddhaQuotesSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BuddhaQuotes_sdk.rb")
  SDK_CLASS = "BuddhaQuotesSDK"
