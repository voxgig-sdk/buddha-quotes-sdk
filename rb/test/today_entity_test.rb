...
class TodayEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set BUDDHAQUOTES_TEST_TODAY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def today_basic_setup(extra)
  ...
  entid_env_raw = ENV["BUDDHAQUOTES_TEST_TODAY_ENTID"]
