...
type Args struct {
	Entity string         `json:"entity" jsonschema:"random | today"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BuddhaQuotesSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "buddha-quotes_list",
		Description: "List records from BuddhaQuotes. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "buddha-quotes_load",
		Description: "Load a single record from BuddhaQuotes. " +
...
func runOp(client *sdk.BuddhaQuotesSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BuddhaQuotesSDK, name string) (sdk.BuddhaQuotesEntity, error) {
