// Command BuddhaQuotes-mcp is an MCP server exposing the BuddhaQuotes
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BuddhaQuotes_list  — list records of an entity
//	BuddhaQuotes_load  — load a single record of an entity
//
