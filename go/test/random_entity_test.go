...
func TestRandomEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set BUDDHAQUOTES_TEST_RANDOM_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func randomBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BUDDHAQUOTES_TEST_RANDOM_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BUDDHAQUOTES_TEST_RANDOM_ENTID"])
