...
func TestTodayEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if todayRef01DataDt0Loaded == nil {
...
func todayBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BUDDHA_QUOTES_TEST_TODAY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BUDDHA_QUOTES_TEST_TODAY_ENTID"])
	...
	if env["BUDDHA_QUOTES_TEST_LIVE"] == "TRUE" {
		...
		client = sdk.NewBuddhaQuotesSDK(core.ToMapAny(mergedOpts))
	}
