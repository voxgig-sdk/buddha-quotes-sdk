...
func TestTodayEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set BUDDHAQUOTES_TEST_TODAY_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func todayBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("BUDDHAQUOTES_TEST_TODAY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["BUDDHAQUOTES_TEST_TODAY_ENTID"])
