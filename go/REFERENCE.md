# BuddhaQuotes Golang SDK Reference

Complete API reference for the BuddhaQuotes Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *BuddhaQuotesSDK`
...
#### `Random(data map[string]any) BuddhaQuotesEntity`

Create a new `Random` entity instance. Pass `nil` for no initial data.

#### `Today(data map[string]any) BuddhaQuotesEntity`
