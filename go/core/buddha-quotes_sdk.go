...
func (sdk *BuddhaQuotesSDK) OptionsMap() map[string]any {
...
func (sdk *BuddhaQuotesSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BuddhaQuotesSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BuddhaQuotesSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BuddhaQuotesSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *BuddhaQuotesSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *BuddhaQuotesSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("BuddhaQuotesSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *BuddhaQuotesSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BuddhaQuotesSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("BuddhaQuotesSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BuddhaQuotesSDK {
	...
	sdk := NewBuddhaQuotesSDK(sdkopts)
	sdk.Mode = "test"
