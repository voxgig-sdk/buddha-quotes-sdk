...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/buddha-quotes` | `npm install @voxgig-sdk/buddha-quotes` |
| Python | `voxgig-sdk-buddha-quotes` | `pip install voxgig-sdk-buddha-quotes` |
| PHP | `voxgig-sdk/buddha-quotes` | `composer require voxgig-sdk/buddha-quotes` |
| Golang | `github.com/voxgig-sdk/buddha-quotes-sdk/go` | `go get github.com/voxgig-sdk/buddha-quotes-sdk/go` |
| Ruby | `voxgig-sdk-buddha-quotes` | `gem install voxgig-sdk-buddha-quotes` |
| Lua | `voxgig-sdk-buddha-quotes` | `luarocks install voxgig-sdk-buddha-quotes` |
