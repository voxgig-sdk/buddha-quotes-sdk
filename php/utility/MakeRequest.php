...
// BuddhaQuotes SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class BuddhaQuotesMakeRequest
{
    public static function call(BuddhaQuotesContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new BuddhaQuotesResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new BuddhaQuotesResponse($fetched);
        } else {
