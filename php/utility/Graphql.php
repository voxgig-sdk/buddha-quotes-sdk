...
// BuddhaQuotes SDK utility: graphql
//
...
class BuddhaQuotesGraphql
{
    ...
    // equivalent.
    public static function body(BuddhaQuotesContext $ctx): mixed
    {
    ...
    public static function errors(BuddhaQuotesContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
