...
// BuddhaQuotes SDK utility: fetcher

class BuddhaQuotesFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BuddhaQuotesSDK/1.0)';
    ...
    public static function call(BuddhaQuotesContext $ctx, string $fullurl, array $fetchdef): array
    {
