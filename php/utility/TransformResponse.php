...
// BuddhaQuotes SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class BuddhaQuotesTransformResponse
{
    public static function call(BuddhaQuotesContext $ctx): mixed
    {
        ...
        $transform = BuddhaQuotesHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
