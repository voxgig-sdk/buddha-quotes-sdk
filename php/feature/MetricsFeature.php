...
// BuddhaQuotes SDK metrics feature
...
class BuddhaQuotesMetricsFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _record(BuddhaQuotesContext $ctx, bool $ok): void
    {
