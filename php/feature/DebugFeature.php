...
// BuddhaQuotes SDK debug feature
...
class BuddhaQuotesDebugFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _finish(BuddhaQuotesContext $ctx, bool $ok): void
    {
