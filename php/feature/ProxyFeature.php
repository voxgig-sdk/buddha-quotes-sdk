...
// BuddhaQuotes SDK proxy feature
...
class BuddhaQuotesProxyFeature extends BuddhaQuotesBaseFeature
{
    ...
    public function init(BuddhaQuotesContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BuddhaQuotesContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
