...
// BuddhaQuotes SDK cache feature
...
class BuddhaQuotesCacheFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _through(BuddhaQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
