...
// BuddhaQuotes SDK audit feature
...
class BuddhaQuotesAuditFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _emit(BuddhaQuotesContext $ctx, string $outcome): void
    {
