...
// BuddhaQuotes SDK ratelimit feature
...
class BuddhaQuotesRatelimitFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _acquire(BuddhaQuotesContext $ctx): void
    {
    ...
    private function _track(BuddhaQuotesContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
