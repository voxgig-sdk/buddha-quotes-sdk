...
class BuddhaQuotesRbacFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _required(BuddhaQuotesContext $ctx): ?string
    {
    ...
    private function _reject(BuddhaQuotesContext $ctx, string $required): void
    {
    ...
    private function _track(BuddhaQuotesContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
