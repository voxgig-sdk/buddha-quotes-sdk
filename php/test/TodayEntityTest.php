...
class TodayEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set BUDDHA_QUOTES_TEST_TODAY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function today_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("BUDDHA_QUOTES_TEST_TODAY_ENTID");
    ...
    if ($env["BUDDHA_QUOTES_TEST_LIVE"] === "TRUE") {
