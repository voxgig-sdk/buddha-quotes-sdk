...
// BuddhaQuotes SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BuddhaQuotesSDK::test)
...
{
    private const SDK_CLASS = 'BuddhaQuotesSDK';
    ...
    private const SDK_BASE = 'buddhaquotes_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../buddhaquotes_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
