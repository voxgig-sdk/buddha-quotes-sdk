# BuddhaQuotes PHP SDK



The PHP SDK for the BuddhaQuotes API — an entity-oriented client using PHP conventions.
...
```
php/
├── buddhaquotes_sdk.php          -- Main SDK class
...
The main class (`buddhaquotes_sdk.php`) exports the SDK class
