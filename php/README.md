...
The PHP SDK for the BuddhaQuotes API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Random(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->BuddhaQuotes(null)->load(
    ["id" => "test01"], null
);
