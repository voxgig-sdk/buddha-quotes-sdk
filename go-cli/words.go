...
func registerSDKWords(r *eng.Registry, client *sdk.BuddhaQuotesSDK) {
...
func runOp(client *sdk.BuddhaQuotesSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
