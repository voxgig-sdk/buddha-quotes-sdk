...
AQL-driven CLI and REPL for the BuddhaQuotes SDK. Positional arguments are
...
./buddha-quotes-cli list random
./buddha-quotes-cli load 1 random
./buddha-quotes-cli load '{id:1}' random
