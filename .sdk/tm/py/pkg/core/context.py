...
from projectname_sdk.core.control import BuddhaQuotesControl
...
class BuddhaQuotesContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, BuddhaQuotesSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BuddhaQuotesResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BuddhaQuotesResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return BuddhaQuotesError(code, msg, self)
