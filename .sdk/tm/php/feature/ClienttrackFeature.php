...
// BuddhaQuotes SDK clienttrack feature
...
class BuddhaQuotesClienttrackFeature extends BuddhaQuotesBaseFeature
{
    ...
    public function PostConstruct(BuddhaQuotesContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BuddhaQuotes-SDK';
