...
// BuddhaQuotes SDK streaming feature
...
class BuddhaQuotesStreamingFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _iterate(BuddhaQuotesResult $result): \Generator
    {
    ...
    private function _streamable(BuddhaQuotesContext $ctx): bool
    {
