...
// BuddhaQuotes SDK timeout feature
...
class BuddhaQuotesTimeoutFeature extends BuddhaQuotesBaseFeature
{
    ...
    private function _with_timeout(BuddhaQuotesContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BuddhaQuotesContext $_ctx, float $ms): void
    {
        $client = $this->client;
