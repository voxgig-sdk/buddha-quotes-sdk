...
// BuddhaQuotes SDK utility type

class BuddhaQuotesUtility
{
    ...
    public static function copy(BuddhaQuotesUtility $src): BuddhaQuotesUtility
    {
        $u = new BuddhaQuotesUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
