...
// BuddhaQuotes SDK pipeline test
//
...
{
    private static function utility(): BuddhaQuotesUtility
    {
        return new BuddhaQuotesUtility();
    }
    ...
    private static function ctx(array $over = []): BuddhaQuotesContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BuddhaQuotesContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BuddhaQuotesOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BuddhaQuotesError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BuddhaQuotesOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BuddhaQuotesMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BuddhaQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BuddhaQuotesMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BuddhaQuotesOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BuddhaQuotesMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BuddhaQuotesSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BuddhaQuotesMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BuddhaQuotesResponse([]),
            'result' => new BuddhaQuotesResult([]),
        ]);
        [, $err] = BuddhaQuotesMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BuddhaQuotesSpec([]),
            'response' => null,
            'result' => new BuddhaQuotesResult([]),
        ]);
        [, $err] = BuddhaQuotesMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BuddhaQuotesSpec(['step' => 's']),
            'response' => new BuddhaQuotesResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BuddhaQuotesResult([]),
        ]);
        [, $err] = BuddhaQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BuddhaQuotesSpec(['step' => 's']),
            'response' => new BuddhaQuotesResponse(self::resp(200, ['v' => 1])),
            'result' => new BuddhaQuotesResult([]),
        ]);
        [, $err] = BuddhaQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BuddhaQuotesSpec(['step' => 's']),
            'response' => new BuddhaQuotesResponse(self::resp(200, ['v' => 2])),
            'result' => new BuddhaQuotesResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BuddhaQuotesMakeResponse::call($ctx);
    ...
    {
        $preset = new BuddhaQuotesResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BuddhaQuotesSpec([]),
            'response' => new BuddhaQuotesResponse([]),
            'result' => new BuddhaQuotesResult([]),
        ...
        [$got, $err] = BuddhaQuotesMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BuddhaQuotesResult([])]);
        [, $err] = BuddhaQuotesMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BuddhaQuotesSpec([]), 'result' => null]);
        [, $err] = BuddhaQuotesMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BuddhaQuotesSpec(['step' => 's']),
            'result' => new BuddhaQuotesResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BuddhaQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BuddhaQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BuddhaQuotesSpec(['step' => 's']),
            'result' => new BuddhaQuotesResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BuddhaQuotesOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BuddhaQuotesMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BuddhaQuotesResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BuddhaQuotesSpec([]),
            'result' => new BuddhaQuotesResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BuddhaQuotesMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BuddhaQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BuddhaQuotesError('boom', 'boom');
        $utility->fetcher = function (BuddhaQuotesContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BuddhaQuotesSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BuddhaQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BuddhaQuotesContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BuddhaQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BuddhaQuotesResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BuddhaQuotesMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BuddhaQuotesContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BuddhaQuotesSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BuddhaQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BuddhaQuotesResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BuddhaQuotesSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BuddhaQuotesMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BuddhaQuotesMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BuddhaQuotesMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BuddhaQuotesResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BuddhaQuotesDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BuddhaQuotesResult(['ok' => false])]);
        $this->expectException(BuddhaQuotesError::class);
        BuddhaQuotesDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BuddhaQuotesResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BuddhaQuotesMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BuddhaQuotesMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BuddhaQuotesBaseFeature();
        $b = new BuddhaQuotesBaseFeature();
        BuddhaQuotesFeatureAdd::call($ctx, $a);
        BuddhaQuotesFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BuddhaQuotesBaseFeature
    {
        $f = new BuddhaQuotesBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BuddhaQuotesFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BuddhaQuotesContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BuddhaQuotesSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BuddhaQuotesPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BuddhaQuotesPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BuddhaQuotesResponse(['headers' => null]),
            'result' => new BuddhaQuotesResult([]),
        ]);
        BuddhaQuotesResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BuddhaQuotesResultBody::call($ctx);
