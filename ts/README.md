# BuddhaQuotes TypeScript SDK



The TypeScript SDK for the BuddhaQuotes API — a type-safe, entity-oriented client with full async/await support.

The API is exposed as capitalised, semantic **Entities** — e.g.
`client.Random()` — each with a small set of operations (`load`)
...
| `tester(testopts?, sdkopts?)` | `BuddhaQuotesSDK` | Create a test-mode client instance. |

#### Static methods

| Method | Returns | Description |
| --- | --- | --- |
| `BuddhaQuotesSDK.test(testopts?, sdkopts?)` | `BuddhaQuotesSDK` | Create a test-mode client. |
...
| `client` | `client(): BuddhaQuotesSDK` | Return the parent SDK client. |
...
buddha-quotes/
├── src/
│   ├── BuddhaQuotesSDK.ts        # Main SDK class
