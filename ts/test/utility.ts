...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BUDDHA_QUOTES_TEST_LIVE ||
    'TRUE' === process.env.BUDDHA_QUOTES_TEST_OVERRIDE
  ) {
  ...
  m.BUDDHA_QUOTES_TEST_EXPLAIN = process.env.BUDDHA_QUOTES_TEST_EXPLAIN || m.BUDDHA_QUOTES_TEST_EXPLAIN
