...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.BUDDHAQUOTES_TEST_LIVE ||
    'TRUE' === process.env.BUDDHAQUOTES_TEST_OVERRIDE
  ) {
  ...
  m.BUDDHAQUOTES_TEST_EXPLAIN = process.env.BUDDHAQUOTES_TEST_EXPLAIN || m.BUDDHAQUOTES_TEST_EXPLAIN
