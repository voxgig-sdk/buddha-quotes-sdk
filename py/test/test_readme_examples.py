# BuddhaQuotes SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BuddhaQuotesSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BuddhaQuotesSDK(...) and BuddhaQuotesSDK.test(...) become
#      BuddhaQuotesSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "buddhaquotes_sdk"
_SDK_CLASS = "BuddhaQuotesSDK"
