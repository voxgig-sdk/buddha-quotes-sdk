...
from buddhaquotes_sdk.utility import register

# Load features
from buddhaquotes_sdk.feature.base_feature import BuddhaQuotesBaseFeature
from buddhaquotes_sdk.features import _make_feature
...
class BuddhaQuotesSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = BuddhaQuotesUtility()
        self._utility = utility

        from buddhaquotes_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return BuddhaQuotesUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("BuddhaQuotesSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from buddhaquotes_sdk.entity.random_entity import RandomEntity
        return RandomEntity(self, data)


    def Today(self, data=None) -> "TodayEntity":
        """Entity factory: client.Today().list() / client.Today().load({"id": ...})."""
        from buddhaquotes_sdk.entity.today_entity import TodayEntity
        return TodayEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "BuddhaQuotesSDK":
        if sdkopts is None:
            sdkopts = {}
