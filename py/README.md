# BuddhaQuotes Python SDK



The Python SDK for the BuddhaQuotes API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Random()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/buddha-quotes-sdk/releases)) or
...
```
py/
├── buddhaquotes_sdk.py         -- Main SDK module
